...
void AddDescriptors_mathtest_2eproto();
namespace mathtest {
class MathReply;
...
class MathRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mathtest.MathRequest) */ {
 public:
  MathRequest();
  virtual ~MathRequest();
...
class MathReply final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:mathtest.MathReply) */ {
 public:
  MathReply();
  virtual ~MathReply();
